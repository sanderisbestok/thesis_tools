...
detFolderOrig = detFolder

results = {}

for i in range(int(args.start), int(args.stop)+int(args.step), int(args.step)):
    detFolder = os.path.join(detFolderOrig, str(i))
    print(detFolder)    
...
w = csv.writer(open("/home/sander/results.txt", "w"))
